...
with st.expander("📘 Guia de Interpretação dos Indicadores Técnicos"):
    st.markdown("""
    ### 📉 RSI — Índice de Força Relativa
    O RSI mede o **sentimento do mercado** — se os ativos estão sobrecomprados ou sobrevendidos.
    - Abaixo de 30 → *Sobrevendido* (potencial oportunidade de compra) 📉
    - Entre 30 e 70 → *Zona neutra* 📊
    - Acima de 70 → *Sobrecomprado* (potencial correção) 📈
    ### 🐻🐂 MACD — Convergência/Divergência de Médias Móveis
    O MACD mostra a **tendência do mercado**, comparando médias móveis de curto e longo prazo.
    - Abaixo de -0.5 → *Tendência de baixa* 🐻
    - Entre -0.5 e 0.5 → *Zona neutra / transição* ⚖️
    - Acima de 0.5 → *Tendência de alta* 🐂
    ### 🪙💰🏦 Volume — Convicção dos Players
    O volume representa a **convicção dos investidores** — quanto interesse há na negociação.
    - Abaixo de 80% da média → *Baixa convicção* 🪙
    - Entre 80% e 120% da média → *Volume normal* 💰
    - Acima de 120% da média → *Alta convicção* 🏦
    """)