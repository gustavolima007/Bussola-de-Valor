...
import pyarrow.parquet as pq  # Adicionado para suporte a Parquet
...
def extrair_dados_brapi():
    ...
    parquet_output = base_dir / "acoes_e_fundos.parquet"  # Novo arquivo Parquet
    ...
    try:
        ...
        # Novo: Salvar como arquivo Parquet
        df_ativos.to_parquet(parquet_output, index=False, engine='pyarrow')
        logger.info(f"Arquivo Parquet salvo: {parquet_output}")
