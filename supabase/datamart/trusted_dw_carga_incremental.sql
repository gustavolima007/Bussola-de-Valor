-- Carga incremental da tabela trusted_dw.acoes_e_fundos (ultimos 30 dias)
...
-- Carga incremental da tabela trusted_dw.todos_dividendos (ultimos 30 dias)
...
-- Carga incremental da tabela trusted_dw.precos_acoes_completo (ultimos 30 dias)
...
-- Carga incremental da tabela trusted_dw.dividendos_ano_resumo (ultimos 30 dias)
...
-- Carga incremental da tabela trusted_dw.dividendos_ano (ultimos 30 dias)
